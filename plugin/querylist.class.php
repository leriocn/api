<?php
	...
	class QueryList{
		  ...
		  */
		public function  __construct($page,$regArr,$regRange='',$getHtmlWay="curl",$output_encoding=false,$postData=false)
		 {
			...
			if($this->isURL($page))
		 	{
		        ...
		        }else if($getHtmlWay=="curlpost")
		        {
				   ...
				   $ch = curl_init();
				    ...
				    curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($postData));//要提交的信息
					$this->html = curl_exec($ch);
